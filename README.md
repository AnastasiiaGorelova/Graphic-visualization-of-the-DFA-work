...
Далее есть возможность получить графическое представление введенного ДКА, а также того, по каким ребрам прошла провалидированная строчка. Если же строка не принадлежит языку, появляется окошко, сообщающее пользователю данную информацию.
